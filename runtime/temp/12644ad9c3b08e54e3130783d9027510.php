<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"D:\AppServ\www/application/admin\view\index\index.php";i:1572856953;s:54:"D:\AppServ\www\application\admin\view\public\style.php";i:1555899696;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer"  @touchmove.prevent>
            <div class="pull-right">© 2014-2020 <a href="" target="_blank">张栋</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
